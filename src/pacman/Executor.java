...
//        exec.runGame(new AStarPacMan(),new RandomGhosts(), visual, 10);
//        exec.runGame(new AStarPacMan(),new StarterGhosts(), visual, 10);

//        exec.runExperiment(new AStarPacMan(),new RandomGhosts(), 1100);
//        exec.runExperiment(new AStarPacMan(),new StarterGhosts(), 1100);


//        exec.runGame(new BTPacMan(),new RandomGhosts(), visual, 10);
//        exec.runGame(new BTPacMan(),new AggressiveGhosts(), visual, 15);
//        exec.runGame(new BTPacMan(),new Legacy(), visual, 10);
//        exec.runGame(new BTPacMan(),new StarterGhosts(), visual, 5);


//        exec.runExperiment(new BTPacMan(),new RandomGhosts(), 10);
//        exec.runExperiment(new BTPacMan(),new AggressiveGhosts(), 10);
//        exec.runExperiment(new BTPacMan(),new Legacy(), 10);
        exec.runExperiment(new BTPacMan(),new StarterGhosts(), 10);
...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);
    ...
    public void runExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
        ...
        for(int i=0;i<trials;i++)
        {
            ...
            System.out.println(String.format("%4d, %6d, %2d, %6d ", i , game.getScore(), game.getCurrentLevel(), game.getTotalTime()));
        }
    ...
    public ArrayList<Float> getExperimentValue(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
        ...
        for(int i=0;i<trials;i++)
        {
            ...
            if (game.getScore() < minScore) minScore = game.getScore();
...
//        System.out.println("Average level: " + avgLevel/trials);
        ...
        out.add((float)avgScore/trials);
        out.add((float)maxScore);
        out.add((float)minScore);
